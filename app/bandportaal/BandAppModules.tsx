...
function MessageCommentsSection({ messageId, comments, profiles, userId, isAdmin, busy, onCreateComment, onUpdateComment, onDeleteComment }: { messageId: string; comments: MessageComment[]; profiles: Profile[]; userId: string; isAdmin: boolean; busy: boolean; onCreateComment: (messageId: string, body: string) => Promise<boolean>; onUpdateComment: (id: string, body: string) => Promise<boolean>; onDeleteComment: (id: string) => void }) {
